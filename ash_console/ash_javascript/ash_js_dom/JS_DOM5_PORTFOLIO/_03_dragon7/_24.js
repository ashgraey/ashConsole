...
function changeStage(stage){
    if(stage == 1){
        ...
        bg1["img"].src = "image/stage_03.png";
        bg2["img"].src = "image/stage_03.png";
        bg3["img"].src = "image/stage_03.png";
    }
}
function drawBg() {
...
var gameData = {score : 0 , stage : 1 , run : true , enemyTimer : 0 , state : "title"}
